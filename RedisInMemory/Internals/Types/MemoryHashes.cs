...
namespace Neutral.TestingUtilities.RedisInMemory.Internals.Types
{
    ...
    internal class MemoryHashes
    {
        ...
        internal async Task<RedisValue> GetAsync(string hashKey, RedisValue key,
            Func<RedisValue, Task<RedisValue>> retrieval)
        {
        ...
        internal async Task<RedisValue[]> GetMultiAsync(string hashKey, RedisValue[] keys,
            Func<RedisValue[], Task<RedisValue[]>> retrieval)
        {
            if (!keys.Any()) return new RedisValue[0];
        ...
        public Dictionary<string, RedisValue> GetHash(string hashKey)
        {
